...
function ServeState:enter(params)
    -- grab game state from params (These are parameters passed to servestate:enter from paddleselectstate:change)
    ...
    -- init new ball (These are new parameters that are initialised in this table - THEY'RE NOT FIELDS OF params!!!)
    self.ball = Ball()
